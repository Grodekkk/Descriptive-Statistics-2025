...
```python
mostFrequent = users['occupation'].value_counts().idxmax()
print(mostFrequent)
```
...
```python
data = pd.read_csv('https://raw.githubusercontent.com/kflisikowsky/pandas_exercises/refs/heads/main/Euro_2012_stats_TEAM.csv')
```
